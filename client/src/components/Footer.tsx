/*
 * Footer — Mc&Mamoo Growth Engine Website Footer
      ...
      <div className="container">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div>
            ...
            <p className="text-white/30 text-xs tracking-wide">
              {isEn
                ? "Mc&Mamoo Brand Management Inc. · World's #1 New Consumer Brand Management Company"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/20 text-xs">
            {isEn
              ? "©2024 Mc&Mamoo Brand Management Inc. All Rights Reserved."
        ...
        <div className="mt-6 pt-4 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-2">
          ...
          <span className="text-white/10 text-xs font-['DM_Mono'] tracking-widest hidden sm:inline">
            {isEn ? "— Global Financial Ecosystem of the Same Family" : "— 同一家族旗下的全球金融生态"}
          </span>
        </div>
      </div>
    </footer>
