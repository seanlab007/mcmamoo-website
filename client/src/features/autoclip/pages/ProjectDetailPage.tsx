...
const ProjectDetailPage: React.FC<ProjectDetailPageProps> = ({ params: routeParams }) => {
  // 优先从 Route props 接收 params（wouter 方式），否则用 useParams（兼容）
    ...
    return (
      <Content style={{ padding: '24px' }}>
        <Alert
          ...
          type="error"
          action={
            <Button size="small" onClick={() => navigate('/autoclip')}>
              返回首页
            </Button>
          }
        />
