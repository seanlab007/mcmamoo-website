...
export default function CasePangge() {
  useSEO({
    title: "湖南胖哥食品 · 槟榔行业领袖品牌战略升级 | 猫眼增长引擎 Mc&Mamoo Growth Engine",
    description: "猫眼增长引擎 Mc&Mamoo Growth Engine助力湖南胖哥食品完成品牌战略升级，打响四大战役，成为槟榔行业洗牌期领先品牌。100万+终端网点，400+经销商，覆盖全国主要地级市。",
    ...
    type: "article",
    keywords: "胖哥食品,槟榔品牌营销,快消品战略,品牌战略升级,渠道扩张,终端网点,经销商管理,猫眼增长引擎 Mc&Mamoo Growth Engine案例,湖南品牌",
    breadcrumbs: [
      { name: "首页", url: "/" },
      { name: "标杆案例", url: "/#cases" },
    ...
    jsonLd: [
      {
        ...
        "description": "猫眼增长引擎 Mc&Mamoo Growth Engine助力湖南胖哥食品完成品牌战略升级，打响四大战役，成为槟榔行业洗牌期领先品牌，100万+终端网点覆盖全国。",
        "image": "https://d2xsxph8kpxj0f.cloudfront.net/310519663405311158/V3i2B4simdfhuwmzceY7AV/800511093070b2f8324e764a335e8869_94eff669.jpg",
        "url": "https://www.mcmamoo.com/cases/pangge",
    ...
    <div style={{ background: "#0A0A0A", minHeight: "100vh", color: "#fff" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-20">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative overflow-hidden" style={{ border: "1px solid rgba(201,168,76,0.2)" }}>
              ...
              >
                猫眼增长引擎 Mc&Mamoo Growth Engine × 胖哥食品
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20 relative overflow-hidden" style={{ border: "1px solid rgba(201,168,76,0.2)" }}>
          <img src={IMGS.studio} alt="猫眼增长引擎 Mc&Mamoo Growth Engine合作现场" className="w-full h-72 md:h-96 object-cover object-center" />
          <div
            className="absolute inset-0"
          ...
          <div className="absolute inset-0 flex items-center px-8 md:px-16">
            <div className="max-w-sm">
              ...
              <p className="text-sm mt-3" style={{ color: "rgba(255,255,255,0.6)" }}>
                猫眼增长引擎 Mc&Mamoo Growth Engine团队深度驻场，全程陪跑品牌升级落地
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)", fontFamily: "'DM Mono', monospace" }}>
            — Sean DAI，猫眼增长引擎 Mc&Mamoo Growth Engine创始人
          </p>
        </div>
        ...
        <ShareBar title="湖南胖哥食品品牌战略升级案例 | 猫眼增长引擎 Mc&Mamoo Growth Engine" />
