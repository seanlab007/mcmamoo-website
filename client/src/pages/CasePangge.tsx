...
export default function CasePangge() {
  useSEO({
    title: "湖南胖哥食品 — 品牌战略升级案例 | 猫眼增长引擎",
    description: "猫眼增长引擎助力湖南胖哥食品完成品牌战略升级，打响四大战役，成为槟榔行业洗牌期领先品牌。100万+终端网点，400+经销商，覆盖全国主要地级市。猫眼增长引擎错位竞争理论实战案例。",
    keywords: "胖哥食品,槟榔品牌,猫眼增长引擎,品牌升级,错位竞争,新消费,槟榔行业,湖南食品",
    ...
    <div style={{ background: "#0A0A0A", minHeight: "100vh", color: "#fff" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-20">
        ...
        <div className="mb-20 relative overflow-hidden" style={{ border: "1px solid rgba(201,168,76,0.2)" }}>
          <img src={IMGS.studio} alt="猫眼增长引擎合作现场" className="w-full h-72 md:h-96 object-cover object-center" />
          <div
            className="absolute inset-0"
        ...
        <ShareBar title="湖南胖哥食品品牌战略升级案例 | 猫眼增长引擎" />
