...
=======
    title: "小仙炖鲜炖燕窝 · 5年营收20亿 · 天猫品类第一 | 猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)",
    description: "猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)助力小仙炖开创鲜炖燕窝新品类，5年在线营收突破20亿，成为天猫燕窝类目长期第一。通过品类错位+场景错位+陈数入股IP策略，建立竞争壁垒。",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663405311158/V3i2B4simdfhuwmzceY7AV/xiaoxiandun-hero-MSw4oXFtJRpVC9YWG9wg4G.webp",
    url: "https://www.mcmamoo.com/cases/xiaoxiandun",
    type: "article",
    keywords: "小仙炖,鲜炖燕窝,燕窝品牌,天猫第一品牌,新消费品牌营销,品类创新,猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)案例,滋补品牌,燕窝市场",
...
=======
        "description": "猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)助力小仙炖开创鲜炖燕窝品类，通过品类错位+场景错位策略，5年营收突破20亿，成为天猫燕窝类目第一品牌。",
>>>>>>> origin/fix/final-navbar-restructure-1774631973
        "image": "https://d2xsxph8kpxj0f.cloudfront.net/310519663405311158/V3i2B4simdfhuwmzceY7AV/xiaoxiandun-hero-MSw4oXFtJRpVC9YWG9wg4G.webp",
        "url": "https://www.mcmamoo.com/cases/xiaoxiandun",
...
=======
                猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)洞察到一个关键空白：<strong style={{ color: "#C9A84C" }}>鲜炖燕窝</strong>——这一兼具营养活性与便捷性的全新品类，
>>>>>>> origin/fix/final-navbar-restructure-1774631973
                市场几乎为零。
              </p>
              <p style={{ color: "rgba(245,240,232,0.75)", lineHeight: 1.9, fontSize: "0.95rem", marginBottom: 20 }}>
...
=======
          <SectionHeader en="Strategic Execution" zh="猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)操盘策略" />
>>>>>>> origin/fix/final-navbar-restructure-1774631973
...
=======
                猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine)的错位竞争战略，帮助小仙炖在5年内从微商品牌跃升为天猫品类第一，
>>>>>>> origin/fix/final-navbar-restructure-1774631973
      ...
      <div className="px-8 md:px-20 py-6" style={{ borderTop: "1px solid rgba(201,168,76,0.08)" }}>
        <ShareBar title="小仙炖鲜炖燕窩" description="开创鲜炖燕窩品类，5年偖20亿营收" />
      </div>
...
=======
          © 2024 Mc&Mamoo Brand Management Inc. · 猫眼增长引擎 (Mc&Mamoo Growth Engine)增长引擎 (Mc&Mamoo Growth Engine) · 小仙炖案例
>>>>>>> origin/fix/final-navbar-restructure-1774631973
        </p>
      </div>
    </div>
