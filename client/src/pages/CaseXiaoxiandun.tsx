...
export default function CaseXiaoxiandun() {
  useSEO({
    title: "小仙炖鲜炖燕窝 · 5年营收20亿 · 天猫品类第一 | 猫眼增长引擎 Mc&Mamoo Growth Engine",
    description: "猫眼增长引擎 Mc&Mamoo Growth Engine助力小仙炖开创鲜炖燕窝新品类，5年在线营收突破20亿，成为天猫燕窝类目长期第一。通过品类错位+场景错位+陈数入股IP策略，建立竞争壁垒。",
    ...
    type: "article",
    keywords: "小仙炖,鲜炖燕窝,燕窝品牌,天猫第一品牌,新消费品牌营销,品类创新,猫眼增长引擎 Mc&Mamoo Growth Engine案例,滋补品牌,燕窝市场",
    breadcrumbs: [
      { name: "首页", url: "/" },
      { name: "标杆案例", url: "/#cases" },
    ...
    jsonLd: [
      {
        ...
        "description": "猫眼增长引擎 Mc&Mamoo Growth Engine助力小仙炖开创鲜炖燕窝品类，通过品类错位+场景错位策略，5年营收突破20亿，成为天猫燕窝类目第一品牌。",
        "image": "https://d2xsxph8kpxj0f.cloudfront.net/310519663405311158/V3i2B4simdfhuwmzceY7AV/xiaoxiandun-hero-MSw4oXFtJRpVC9YWG9wg4G.webp",
        "url": "https://www.mcmamoo.com/cases/xiaoxiandun",
  ...
  return (
    <div style={{ background: "#080C14", minHeight: "100vh", color: "#F5F0E8" }}>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <RevealBlock>
              <p style={{ color: "rgba(245,240,232,0.75)", lineHeight: 1.9, fontSize: "0.95rem", marginBottom: 20 }}>
                ...
                猫眼增长引擎 Mc&Mamoo Growth Engine洞察到一个关键空白：<strong style={{ color: "#C9A84C" }}>鲜炖燕窝</strong>——这一兼具营养活性与便捷性的全新品类，
                市场几乎为零。
              </p>
              <p style={{ color: "rgba(245,240,232,0.75)", lineHeight: 1.9, fontSize: "0.95rem", marginBottom: 20 }}>
      ...
      <div className="py-16 px-8 md:px-20" style={{ background: "rgba(201,168,76,0.03)", borderTop: "1px solid rgba(201,168,76,0.1)" }}>
        <div className="max-w-6xl mx-auto">
          <SectionHeader en="Strategic Execution" zh="猫眼增长引擎 Mc&Mamoo Growth Engine操盘策略" />
          ...
          <RevealBlock>
            <div className="p-8" style={{ background: "rgba(201,168,76,0.05)", border: "1px solid rgba(201,168,76,0.2)" }}>
              <p style={{ color: "rgba(245,240,232,0.75)", lineHeight: 1.9, fontSize: "0.95rem" }}>
                ...
                猫眼增长引擎 Mc&Mamoo Growth Engine的错位竞争战略，帮助小仙炖在5年内从微商品牌跃升为天猫品类第一，
