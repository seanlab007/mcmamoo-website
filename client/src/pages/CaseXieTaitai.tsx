...
export default function CaseXieTaitai() {
  useSEO({
    title: "蟹太太大闸蟹 · 从0到8亿营收 · 明星直播第一 | 猫眼增长引擎增长引擎 (MaoEye Growth Engine)标杆案例",
    description: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)操盘蟹太太大闸蟹品牌，从0孵化到年营收8亿，签约黄晓明代言，500+明星网红合作矩阵，贾乃亮单场5700万，小杨哥单场2000万，全网蟹券销量连续多年第一。",
    ...
    type: "article",
    keywords: "蟹太太大闸蟹,大闸蟹品牌,生鲜品牌营销,明星直播带货,黄晓明代言,猫眼增长引擎增长引擎 (MaoEye Growth Engine)案例,品牌从0到1,大闸蟹电商,错位竞争案例",
    breadcrumbs: [
      { name: "首页", url: "/" },
      { name: "标杆案例", url: "/#cases" },
    ...
    jsonLd: [
      {
        ...
        "description": "猫眼增长引擎增长引擎 (MaoEye Growth Engine)操盘蟹太太大闸蟹，填补行业品牌化空白，签约黄晓明担任品牌代言，构建500+明星网红合作矩阵，全网蟹券销量连续多年第一。",
        "image": "https://d2xsxph8kpxj0f.cloudfront.net/310519663405311158/V3i2B4simdfhuwmzceY7AV/hero-video-frame1-9AHtkPtKZTrG9N5GhnTvLQ.png",
        "url": "https://www.mcmamoo.com/cases/xietaitai",
    ...
    <div style={{ background: "#080E18", minHeight: "100vh", color: "white" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-base leading-relaxed mb-6" style={{ color: "rgba(255,255,255,0.7)" }}>
                猫眼增长引擎增长引擎 (MaoEye Growth Engine)介入后，提出"错位竞争"核心战略：在竞争对手还在打价格战时，
      ...
      <div className="py-12 px-8 md:px-20" style={{ borderTop: "1px solid rgba(201,168,76,0.1)" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-base leading-relaxed mb-8 max-w-3xl" style={{ color: "rgba(255,255,255,0.65)" }}>
            通过猫眼增长引擎增长引擎 (MaoEye Growth Engine)构建的全渠道明星矩阵，蟹太太汇聚了黄晓明、刘嘉玲、王宝强、
      ...
      <div className="py-12" style={{ background: "rgba(201,168,76,0.03)", borderTop: "1px solid rgba(201,168,76,0.1)" }}>
        <div className="px-8 md:px-20 max-w-4xl mx-auto">
          <SectionHeader en="Strategic Journey" zh="猫眼增长引擎增长引擎 (MaoEye Growth Engine)操盘历程" />
          <div>
            <TimelineItem
              year="2016"
              title="品牌0到1 — 赛道切入"
              desc="猫眼增长引擎增长引擎 (MaoEye Growth Engine)完成市场调研，发现大闸蟹行业品牌化空白，制定差异化竞争战略，协助苏州西风阁完成品牌定位与视觉体系搭建。"
            />
            <TimelineItem
              year="2018"
              title="明星代言 — 品牌破圈"
      ...
      <div className="py-16 px-8 md:px-20" style={{ borderTop: "1px solid rgba(201,168,76,0.1)" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              猫眼增长引擎增长引擎 (MaoEye Growth Engine)核心贡献
            </div>
      ...
      >
        © 2024 Mc&Mamoo Brand Management Inc. · 猫眼增长引擎和询 · 蟹太太案例
      </div>
    </div>
  );
}
