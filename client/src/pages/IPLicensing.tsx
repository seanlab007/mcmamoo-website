...
const ipData: IPItem[] = [
  // ── 战略合作 ──
  {
    ...
    descCn: "永恒的好莱坞偶像。猫眼增长引擎增长引擎与 Authentic Brands Group（ABG）建立战略合作，将玛丽莲·梦露的经典形象引入中国市场高端品牌联名。",
  ...
  },
  {
    ...
    descCn: "李小龙形象由 Bruce Lee Enterprises 管理。猫眼增长引擎增长引擎协助中国品牌建立高端授权合作，传承这一武术与哲学传奇。",
  ...
  // ── 国家级授权 ──
  {
    ...
    descCn: "革命精神的象征。猫眼增长引擎增长引擎已建立官方政府机构授权渠道，协助高端品牌完成切·格瓦拉形象的合规商业授权。",
  ...
  },
  {
    ...
    descCn: "永恒的反叛者。詹姆斯·迪恩的形象权通过官方授权渠道管理。猫眼增长引擎增长引擎协助时尚、汽车及生活方式品牌完成合规授权。",
...
const categoryConfig = {
  strategic: {
    ...
    descCn: "通过猫眼增长引擎增长引擎与 ABG 集团及全球 IP 管理机构的战略合作，提供官方授权服务",
    color: "#C9A84C",
    dot: "#C9A84C",
  ...
  exclusive: {
    ...
    descCn: "猫眼增长引擎增长引擎精选的高端 IP 资源，可洽谈品牌独家授权合作",
    color: "#60A5FA",
    dot: "#60A5FA",
  ...
  national: {
    ...
    descCn: "通过猫眼增长引擎增长引擎官方政府及机构授权渠道可访问的 IP 资源",
    color: "#F87171",
    dot: "#F87171",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-white/50 text-sm leading-relaxed max-w-2xl">
            {isEn
              ...
              : "猫眼增长引擎增长引擎精选全球最具影响力的 IP 资源——从好莱坞传奇到全球文化符号——为品牌提供独家授权合作，提升品牌溢价，驱动增长。"}
          </p>
              ...
              <div className="flex">
                ...
                <div className="flex-1 p-5">
                  ...
                  <h3 className="font-['Cormorant_Garamond'] text-lg text-white mb-1">
                    {isEn ? "Maoyan World × Van Gogh" : "猫眼增长引擎看世界 × 梵高"}
                  </h3>
                  <p className="text-white/40 text-xs leading-relaxed mb-4">
                    {isEn
                      ...
                      : "高端家居香氛品牌「猫眼增长引擎看世界」推出梵高联名限定系列，以《星夜》《向日葵》为主题，覆盖蚕烛、扩香器等全品类。"}
                  </p>
