 ...
 * 将猫眼自动运营平台嵌入官网（无需登录，直接访问）
 * Migrated: tRPC auth → no auth required
 */
import { useState } from "react";
import { ExternalLink, Loader2, AlertCircle, RefreshCw } from "lucide-react";

// 运营平台地址（mao-yan-platform 部署地址）
const PLATFORM_URL = import.meta.env.VITE_PLATFORM_URL || "https://maoyan.vip";
