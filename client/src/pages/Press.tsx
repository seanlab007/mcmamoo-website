...
const PRESS_RELEASES = [
  {
    ...
    date: "2025-01-22",
    year: 2025,
    title_zh: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)荣获达沃斯全球战略咨询创新领袖奖",
    ...
    excerpt_zh: "在2025年达沃斯全球战略创新论坛上，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）凭借其在AI驱动品牌战略咨询领域的全球领先地位，荣获年度最高荣誉——达沃斯全球战略咨询创新领袖奖。这是猫眼增长引擎增长引擎 (MaoEye Growth Engine)连续第17年在国际舞台获得顶级机构认可。",
    ...
    body_zh: `达沃斯，瑞士，2025年1月22日——猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo Brand Management Inc.）今日宣布，公司荣获达沃斯全球战略创新论坛颁发的"全球战略咨询创新领袖奖"。

本次获奖是对猫眼增长引擎增长引擎 (MaoEye Growth Engine)在人工智能驱动的品牌战略咨询领域所取得成就的高度认可。评审委员会特别指出，猫眼增长引擎增长引擎 (MaoEye Growth Engine)独创的"猫眼增长引擎增长引擎"方法论——涵盖品牌溢价、利润倍增与全域增长三大核心模块——在过去十六年间帮助超过200个中国消费品牌实现了平均3-8倍的溢价提升。

猫眼增长引擎增长引擎 (MaoEye Growth Engine)创始人表示："这个奖项属于我们服务过的每一个品牌。我们的使命从未改变——让中国品牌在全球市场卖出更高的价格、赚取更多的利润、实现更快的增长。"
...
About the Davos Global Strategic Innovation Forum: The Forum convenes annually in Davos, Switzerland, bringing together the world's leading strategic consulting institutions, government decision-makers, and business leaders to explore global strategic innovation trends.`,
  ...
  },
  {
    ...
    date: "2024-06-15",
    year: 2024,
    title_zh: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)入选英国品牌战略研究院全球TOP10咨询机构",
    ...
    city: "London, UK",
    excerpt_zh: "英国品牌战略研究院年度评选结果揭晓，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）成功入选全球品牌战略咨询机构TOP10榜单，成为唯一入选的中国本土咨询机构。",
    ...
    body_zh: `伦敦，英国，2024年6月15日——英国品牌战略研究院今日发布年度全球品牌战略咨询机构TOP10榜单，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）成功入选，成为唯一一家跻身该榜单的中国本土咨询机构。

评选委员会表示，猫眼增长引擎增长引擎 (MaoEye Growth Engine)凭借其在中国消费品牌全域增长领域的系统性方法论、丰富的成功案例以及在亚太市场的深度影响力，从全球数百家机构中脱颖而出。

猫眼增长引擎增长引擎 (MaoEye Growth Engine)的代表性案例包括：帮助小仙炖燕窝从0增长至20亿年销售额，帮助法国奢侈品牌LA CELLE在中国市场实现单日售出2万瓶的突破，以及帮助江中猴姑米稀在3年内实现销售额翻10倍。

这一荣誉进一步巩固了猫眼增长引擎增长引擎 (MaoEye Growth Engine)作为亚太区领先品牌战略咨询机构的国际地位。`,
...
This honor further cements Mc&Mamoo's international standing as a leading brand strategy consulting institution in the Asia-Pacific region.`,
  ...
  },
  {
    ...
    date: "2023-09-08",
    year: 2023,
    title_zh: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)荣获亚太战略咨询协会年度最高荣誉奖",
    ...
    city: "Singapore",
    excerpt_zh: "亚太战略咨询协会年度颁奖典礼在新加坡举行，猫眼增长引擎增长引擎 (MaoEye Growth Engine)凭借在亚太区品牌战略咨询领域的全面领先地位，荣获年度最高荣誉奖。",
    ...
    body_zh: `新加坡，2023年9月8日——亚太战略咨询协会年度颁奖典礼今日在新加坡举行，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）荣获年度最高荣誉奖。

本次获奖是对猫眼增长引擎增长引擎 (MaoEye Growth Engine)在亚太区品牌战略咨询领域全面领先地位的高度认可。评审委员会特别指出，猫眼增长引擎增长引擎 (MaoEye Growth Engine)在过去十五年间，通过其独创的"猫眼增长引擎方法论"，帮助中国消费品牌在亚太市场实现了系统性的品牌溢价提升和全域增长。

猫眼增长引擎增长引擎 (MaoEye Growth Engine)的"毛智库"战略研究部门在全球战略预测领域的85%准确率，以及与IMF、俄罗斯战略研究院、中国人民解放军等顶级机构的深度合作，也是本次获奖的重要因素。`,
...
The 85% accuracy rate of Mc&Mamoo's "Mao Think Tank" strategic research division in global strategic forecasting, as well as its deep collaboration with top institutions including the IMF, Russian Institute for Strategic Studies, and the People's Liberation Army, were also key factors in this recognition.`,
  ...
  },
  {
    ...
    date: "2022-11-03",
    year: 2022,
    title_zh: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)荣获苏黎世国际品牌管理协会卓越机构奖",
    ...
    excerpt_zh: "苏黎世国际品牌管理协会颁发年度卓越机构奖，表彰猫眼增长引擎增长引擎 (MaoEye Growth Engine)在全球品牌管理领域的卓越机构能力和系统方法论。",
    ...
    body_zh: `苏黎世，瑞士，2022年11月3日——苏黎世国际品牌管理协会今日宣布，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）荣获年度卓越机构奖。

这一奖项表彰在全球品牌管理领域具有卓越机构能力和系统方法论的咨询公司。猫眼增长引擎增长引擎 (MaoEye Growth Engine)凭借其在品牌溢价战略、全域增长体系和趋势预判三大核心能力上的系统性积累，从全球候选机构中脱颖而出。

评审委员会特别提到，猫眼增长引擎增长引擎 (MaoEye Growth Engine)在过去十四年间服务的品牌中，客户平均利润率提升超过200%，全域GMV平均增长5-10倍，品牌溢价平均提升3-8倍，这些数据充分证明了其方法论的有效性和可复制性。`,
...
The evaluation committee specifically noted that among the brands Mc&Mamoo has served over the past fourteen years, clients have achieved an average profit margin increase of over 200%, average omni-channel GMV growth of 5-10x, and average brand premium increase of 3-8x — fully demonstrating the effectiveness and replicability of its methodology.`,
  ...
  },
  {
    ...
    date: "2016-10-20",
    year: 2016,
    title_zh: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)荣获巴黎国际奢侈品管理协会战略咨询金奖",
    ...
    city: "Paris, France",
    excerpt_zh: "巴黎国际奢侈品管理协会年度颁奖，猫眼增长引擎增长引擎 (MaoEye Growth Engine)凭借在奢侈品牌战略咨询领域的杰出贡献与创新方法论，荣获战略咨询金奖。",
    ...
    body_zh: `巴黎，法国，2016年10月20日——巴黎国际奢侈品管理协会年度颁奖典礼今日举行，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）荣获战略咨询金奖。

这是猫眼增长引擎增长引擎 (MaoEye Growth Engine)首次在欧洲奢侈品领域获得顶级机构认可。评审委员会指出，猫眼增长引擎增长引擎 (MaoEye Growth Engine)在帮助中国消费品牌向奢侈品和高端定位转型方面，展现出了独特的方法论优势和丰富的实战经验。

猫眼增长引擎增长引擎 (MaoEye Growth Engine)的奢侈品战略方法论核心在于：通过感官语言升级和高端场景渗透，让消费者主动为品牌溢价买单，实现品牌从大众市场向高端市场的系统性跨越。`,
...
The core of Mc&Mamoo's luxury strategy methodology lies in: upgrading sensory language and penetrating high-end scenarios to make consumers proactively pay premium prices for brands, achieving a systematic leap from mass market to premium market.`,
  ...
  },
  {
    ...
    date: "2011-05-12",
    year: 2011,
    title_zh: "猫眼增长引擎增长引擎 (MaoEye Growth Engine)荣获布鲁塞尔战略咨询行业协会大奖",
    ...
    excerpt_zh: "欧洲最具权威的战略咨询行业大奖——布鲁塞尔战略咨询行业协会大奖颁发，猫眼增长引擎增长引擎 (MaoEye Growth Engine)凭借在全球品牌管理领域的行业引领作用荣获此殊荣。",
    ...
    body_zh: `布鲁塞尔，比利时，2011年5月12日——布鲁塞尔战略咨询行业协会年度颁奖典礼今日举行，猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）荣获年度大奖。

这是猫眼增长引擎增长引擎 (MaoEye Growth Engine)成立以来首次获得欧洲顶级战略咨询行业机构的认可。评审委员会表示，猫眼增长引擎增长引擎 (MaoEye Growth Engine)在中国消费品牌全球化战略方面的系统性探索，以及其独创的品牌溢价方法论，在全球咨询行业具有重要的参考价值和引领意义。

这一奖项标志着猫眼增长引擎增长引擎 (MaoEye Growth Engine)正式进入全球顶级战略咨询机构的视野，也为其后续在全球范围内的品牌建设奠定了重要基础。`,
        ...
        <div ref={ref1 as React.RefObject<HTMLDivElement>} className="reveal mb-16">
          ...
          <p className="text-white/40 text-sm max-w-2xl leading-relaxed mb-8">
            {isEn
              ...
              : "猫眼增长引擎增长引擎 (MaoEye Growth Engine)（Mc&Mamoo）官方新闻稿与获奖公告，记录17年来从伊斯坦布尔到达沃斯的全球荣誉历程。"}
          </p>
