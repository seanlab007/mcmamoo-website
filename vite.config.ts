...
// ESM-safe __dirname: works with both native ESM and esbuild bundling
...
const PROJECT_ROOT = (typeof import.meta.dirname === "string" ? import.meta.dirname : null) ?? __dirname_safe;
